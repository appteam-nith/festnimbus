...
public class Team extends AppCompatActivity {
    ...
    private void doWork(final String team_name){
        ...
        int id = getResources().getIdentifier(team_name, "string",Team.this.getPackageName());
        ...
        int id1 = getResources().getIdentifier(team_name + "_contact", "string", Team.this.getPackageName());
